...
const resources = {
  es: {
    translation: {
      ...
      "projects.p5.title": "Interactive Portfolio",
      "projects.p5.desc": "Un portafolio gamificado e interactivo construido con React, Framer Motion y Tailwind CSS. Cuenta con mini-juegos, coleccionables y una experiencia de usuario única.",
  ...
  "en-GB": {
    translation: {
      ...
      "projects.p5.title": "Interactive Portfolio",
      "projects.p5.desc": "A gamified and interactive portfolio built with React, Framer Motion and Tailwind CSS. Features mini-games, collectibles and a unique UX.",
